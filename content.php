          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4">
                <span class="text-muted fw-light">Контент /</span> Контент
              </h4>
              <a class="btn btn-outline-success mb-3" href="content_detail?action=new">Контент нэмэх</a>
              <div class="row mb-5">
              <?
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <h6 class="card-subtitle text-muted"><?=$data["user"];?></h6>
                    </div>
                    <img class="img-fluid" src="./assets/img/elements/10.jpg" alt="Card image cap" />
                    <div class="card-body">
                      <p class="card-text"><?=$data["description"];?></p>
                      <a class="card-link"><?=$data["createAt"];?></a>
                      <a href="content_detail?id=<?=$data["id"];?>" class="card-link">Дэлгэрэнгүй</a>
                    </div>
                  </div>
                </div>
