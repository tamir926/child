  ...
  <div class="container-fluid h-100">
    <div class="row">
      ...
      <div class="col-lg-11 ">
        ...
        <section class="scroll-section mt-card">
          <div class="row g-2">
            <div class="col-12 col-lg-6 col-xxl-3 mb-2">
              <div class="card bg-secondary text-white">
                <div class="h-100 row g-0 card-body align-items-center">
                  ...
                  <div class="col sh-6 ps-3 d-flex flex-column justify-content-center">
                    <div class="row g-0">
                      <div class="col-auto">
                        <div class="cta-2">34</div>
                      </div>
                    </div>
                    <div class="heading mb-0 d-flex align-items-center lh-1-25">Хүүхдийн бүртгэл</div>
                  </div>
                  <div class="col-auto">
                    <div class="sw-6 sh-6 rounded-md d-flex justify-content-center align-items-center">
                      <i data-acorn-icon="user" class="text-white text-xxlarge"></i>
                    </div>
                  </div>
                </div>
              </div>
