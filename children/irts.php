...
while($row = mysqli_fetch_array($query))
{
    ...
    while($row1 = mysqli_fetch_array($query1))
    {
      ...
      $niit_irsen = $row1['niit_irsen']; if(empty($niit_irsen)) {$niit_irsen = 0;}
      $niit_choloo = $row1['niit_choloo']; if(empty($niit_choloo)) {$niit_choloo = 0;}
      $niit_ireegvi = $row1['niit_ireegvi']; if(empty($niit_ireegvi)) {$niit_ireegvi = 0;}
      $niit_uvchtei = $row1['niit_uvchtei']; if(empty($niit_uvchtei)) {$niit_uvchtei = 0;}
