            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Видео</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="index">Нүүр</a>
                                    </li>
                                    <li class="breadcrumb-item active">Видео
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="mb-1 breadcrumb-right">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="videos?action=new"><i class="mr-1" data-feather="plus-square"></i><span class="align-middle">Шинэ видео</span></a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <? 
                                ...
                                <div class="card">
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            <?
                                                $count =0;
                                                $sql = "SELECT *FROM videos ORDER BY dd";
                                                ...
                                                while ($data = mysqli_fetch_array($result))
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?=$data["link"];?></td>
                                                        <td>
                                                            <a class="btn btn-success" href="videos?action=edit&id=<?=$data["id"];?>">Засах</a>
                                                        </td>
                                                    </tr>
                                                    <?
                                                }
                ...
                if ($action=="edit")
                {
                    ...
                    <section id="input-group-basic">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="input-group mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="link" placeholder="Линк" required value="<?=$link;?>"/>
                                                </div>
                        ...
                        <a class="btn btn-danger waves-effect waves-float waves-light mt-1 btn-sm" href="videos?action=delete&id=<?=$video_id;?>">Устгах</a>
                    </section>
                    <?
                }
                ?>
                ...
                if ($action=="editing")
                {
                    ...
                    $sql = "UPDATE videos SET name='$name',link='$link',dd='$dd' WHERE id='$video_id'";
                    ...
                    ?>
                    <a class="btn btn-success" href="videos?action=edit&id=<?=$video_id;?>">Засах</a>
                    <a class="btn btn-primary" href="videos">Жагсаалт</a>
                    <?
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="input-group mb-2">
                                                    <span class="input-group-text" id="basic-addon-search1"><i data-feather="home"></i></span>
                                                    <input type="text" class="form-control" name="name" placeholder="Нэр" required value=""/>
                                                </div>

                                                <div class="input-group mb-2">
                                                    <span class="input-group-text" id="basic-addon-search1"><i data-feather="link-2"></i></span>
                                                    <input type="text" class="form-control" name="link" placeholder="Линк" required value=""/>
                                                </div>
                ...
                if ($action=="adding")
                {
                    ...
                    $sql = "INSERT INTO videos (name,link,dd) VALUES ('$name','$link','$dd')";
