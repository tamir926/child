...
<html lang="en" data-footer="true" data-scrollspy="true">
  <head>
    ...
    <title>Acorn Admin Template | Player Plugin</title>
    <meta
      name="description"
      content="Plyr is a simple, lightweight, accessible and customizable HTML5 and YouTube media player that supports modern browsers."
    />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <section class="scroll-section" id="title">
                <div class="page-title-container">
                  <h1 class="mb-0 pb-0 display-4">Player</h1>
              ...
              <div>
                <div class="card mb-5">
                  <div class="card-body">
                    <p class="mb-0">Plyr is a simple, lightweight, accessible and customizable HTML5 and YouTube media player that supports modern browsers.</p>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-8 col-xxl-4">
                      <div class="card mb-5 sh-45 bg-transparent">
                        <video class="cover player" poster="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg">
                          <source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4" type="video/mp4" />
                        </video>
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-8 col-xxl-4">
                      <div class="card mb-5">
                        <div class="card-body">
                          <!-- Button Trigger -->
                          <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#videoPlayerModal">Modal Video</button>
                          <!-- Modal -->
                          <div class="modal fade modal-close-out modal-player" id="videoPlayerModal" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-xl">
                              <div class="modal-content">
                                <div class="modal-header p-0 border-0">
                                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <video id="modalVideo" poster="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-HD.jpg">
                                  <source src="https://cdn.plyr.io/static/demo/View_From_A_Blue_Moon_Trailer-576p.mp4" type="video/mp4" />
                                </video>
                              </div>
                            </div>
