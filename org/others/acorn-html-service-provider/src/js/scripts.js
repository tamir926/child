 ...
 class Scripts {
  ...
  _initSettings() {
    if (typeof Settings !== 'undefined') {
      const settings = new Settings({attributes: {placement: 'horizontal', layout: 'boxed', color: 'light-sky', navcolor: 'light' }, showSettings: true, storagePrefix: 'acorn-service-provider-'});
    }
  }
