...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Database Detail</title>
    <meta name="description" content="Service Provider Database Detail" />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <!-- Title Start -->
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Database Detail</h1>
