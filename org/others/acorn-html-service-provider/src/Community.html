...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Community</title>
    <meta name="description" content="Service Provider Community" />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <!-- Title Start -->
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Community</h1>
                          ...
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Storage</a>
                              </div>
                            </div>
                        ...
                        <div class="card h-100">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Hosting</a>
                              </div>
                            </div>
                            <div class="row g-0 mb-n2">
                              <div class="col-6 col-sm-3 mb-2">
                        ...
                        <div class="card h-100">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Database</a>
                              </div>
                            </div>
                            <div class="row g-0 mb-n2">
                              <div class="col-6 col-sm-3 mb-2">
                        ...
                        <div class="card h-100">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Accounts</a>
                              </div>
                            </div>
                            <div class="row g-0 mb-n2">
                              <div class="col-6 col-sm-3 mb-2">
                        ...
                        <div class="card h-100">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Analytics</a>
                              </div>
                            </div>
                            <div class="row g-0 mb-n2">
                              <div class="col-6 col-sm-3 mb-2">
                        ...
                        <div class="card h-100">
                          <div class="card-body">
                            <div class="text-center mb-3">
                              ...
                              <div class="d-flex flex-column sh-5">
                                <a href="CommunityList.html" class="heading stretched-link">Support</a>
                              </div>
                            </div>
                            <div class="row g-0 mb-n2">
                              <div class="col-6 col-sm-3 mb-2">
                        ...
                        <div class="row g-0">
                          ...
                          <div class="col">
                            <div class="position-relative mb-4">
                              <a href="CommunityList.html" class="heading d-block body-link stretched-link mb-3">
