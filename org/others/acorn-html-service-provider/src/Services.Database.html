...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Database</title>
    <meta name="description" content="Service Provider Database" />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <!-- Title Start -->
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Database</h1>
                  ...
                  <div class="col-12 col-sm-auto d-flex align-items-center justify-content-end">
                    ...
                    <a href="Services.DatabaseAdd.html" class="btn btn-outline-primary btn-icon btn-icon-start w-100 w-md-auto">
                          ...
                          <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                              <div class="col-11 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                ...
                                <a href="Services.DatabaseDetail.html" class="text-truncate stretched-link">116.41.118.8</a>
                              </div>
                        ...
                        <div class="col">
                          <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                              <div class="col-11 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                <div class="text-muted text-small d-md-none">Ip</div>
                                <a href="Services.DatabaseDetail.html" class="text-truncate stretched-link">116.41.118.9</a>
                              </div>
                              <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                <div class="text-muted text-small d-md-none">Name</div>
                        ...
                        <div class="col">
                          <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                              <div class="col-11 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                <div class="text-muted text-small d-md-none">Ip</div>
                                <a href="Services.DatabaseDetail.html" class="text-truncate stretched-link">74.21.49.144</a>
                              </div>
                              <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                <div class="text-muted text-small d-md-none">Name</div>
                        ...
                        <div class="col">
                          <div class="card-body pt-0 pb-0 h-100">
                            <div class="row g-0 h-100 align-content-center">
                              <div class="col-11 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-1 order-md-1 h-md-100 position-relative">
                                <div class="text-muted text-small d-md-none">Ip</div>
                                <a href="Services.DatabaseDetail.html" class="text-truncate stretched-link">227.191.45.88</a>
                              </div>
                              <div class="col-6 col-md-3 d-flex flex-column justify-content-center mb-2 mb-md-0 order-3 order-md-2">
                                <div class="text-muted text-small d-md-none">Name</div>
