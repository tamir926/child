...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Tickets</title>
    <meta name="description" content="Service Provider Tickets" />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <div class="row">
                <div class="col-12 mb-5">
                  ...
                  <div class="mb-n2">
                    <a href="Support.TicketsDetail.html" class="card mb-2 sh-22 sh-md-8 hover-border-primary">
                      <div class="card-body pt-0 pb-0 h-100">
                        <div class="row g-0 h-100 align-content-center">
