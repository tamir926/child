...
<html lang="en" data-footer="true">
  <head>
    ...
    <title>Acorn Admin Template | Docs</title>
    <meta name="description" content="Service Provider Docs" />
    <!-- Favicon Tags Start -->
            ...
            <div class="col">
              ...
              <div class="page-title-container mb-3">
                <div class="row">
                  <!-- Title Start -->
                  <div class="col mb-2">
                    <h1 class="mb-2 pb-0 display-4" id="title">Docs</h1>
                  ...
                  <div class="card">
                    <div class="card-body sh-45 d-flex align-items-center justify-content-center">
                      <div class="text-center">
                        ...
                        <a href="Support.DocsDetail.html" class="btn btn-primary">CREATE TOKEN</a>
                      </div>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="row row-cols-2 row-cols-xl-3 gy-5" id="apiReferenceMasonry">
                        <div class="col">
                          <div class="card no-shadow">
                            ...
                            <a href="Support.DocsDetail.html" class="d-flex flex-row mb-2 alternate-link">
                              <div class="sw-4"></div>
                  ...
                  <div class="card mb-2 h-100">
                    <div class="card-body row g-0">
                      <div class="col-12">
                        ...
                        <a href="Support.DocsDetail.html" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
                  ...
                  <div class="card mb-2 h-100">
                    <div class="card-body row g-0">
                      <div class="col-12">
                        ...
                        <div class="text-muted mb-4">Cheesecake chocolate carrot cake pie lollipop lemon toffee lollipop. Oat cake pie cake cotton.</div>
                        <a href="Community.html" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
                  ...
                  <div class="card mb-2 h-100">
                    <div class="card-body row g-0">
                      <div class="col-12">
                        ...
                        <a href="Support.KnowledgeBase.html" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
                  ...
                  <div class="card mb-2 h-100">
                    <div class="card-body row g-0">
                      <div class="col-12">
                        ...
                        <div class="text-muted mb-4">Cheesecake chocolate carrot cake pie lollipop lemon toffee lollipop. Oat cake pie cake cotton.</div>
                        <a href="Support.Tickets.html" class="btn btn-icon btn-icon-start btn-outline-primary stretched-link">
