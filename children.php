...
<link rel="stylesheet" href="<?=$path?>assets/css/vendor/OverlayScrollbars.min.css" />
...
<script src="<?=$path?>assets/js/base/loader.js"></script>
            ...
            <div class="d-flex flex-row-reverse">
              <div class="user-container d-flex ms-card">
                <a href="#" class="d-flex user position-relative " data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <img class="profile" alt="profile" src="<?=$path?>assets/img/profile/profile-1.webp">
                </a>
              ...
              <div class="container-fluid">
                <div class="block-header">
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="<?=$path?>list">Хувийн мэдээлэл</a></li>
                      <li class="breadcrumb-item active" aria-current="page">Бүртгэл</li>
                    </ol>
                  </nav>
                </div>
                <div class="row clearfix">
                  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card"><br/><br/>
              			<?php
              			$id = $_GET['id'];
                    $query = mysqli_query($conn,"select a.*   , c.discount  , b.name  from student a , sector b , discount c where  a.sector = b.id and a.discount = c.id and a.id=$id") or die (mysqli_error());
                    ...
                    <table class="table table-striped table-bordered">
                      <tr>
                        ...
                        <img src="<?=$path?>assets/img/no_image.png" width="120px" height="150px;"><br/><br/>
                        <a href="<?=$path?>assets/img/no_image.png" class="btn btn-danger">Засварлах</a><br/>
                        <a style="margin-top:5px;" href="<?=$path?>print_child.php?id=<?=$id?>" target="_blank" class="btn btn-info">Хэвлэх</a>
                        </td>
                    ...
                    <div class="block-header" align="center"><h2>Хувийн хэрэг</h2></div>
                    <?php if(isset($_GET['t'])){ $t = $_GET['t'];} else { $t=0;}?>

                    <ul class="nav nav-tabs">
  <li class="nav-item">
    <a class="nav-link <?php if($t==0) echo 'active'; else 'active';?>" data-bs-toggle="tab" href="#home">Хувийн хэрэг</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?php if($t==1) echo 'active';?>" data-bs-toggle="tab" href="#menu1">Файлууд</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?php if($t==2) echo 'active';?>" data-bs-toggle="tab" href="#menu2">Төлбөр</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?php if($t==3) echo 'active';?>" data-bs-toggle="tab" href="#menu3">Ирц</a>
  </li>
  <li class="nav-item">
    <a class="nav-link <?php if($t==4) echo 'active';?>" data-bs-toggle="tab" href="#menu4">Өөрчлөлтийн түүх</a>
  </li>
</ul>

<!-- Tab panes -->
<div class="tab-content"><br/><br/>
  <div class="tab-pane container <?php if($t==0) echo 'active'; else echo 'active';?>" id="home">
    <?php include 'children/child_family.php';?>
  </div>
  <div class="tab-pane container <?php if($t==1) echo 'active'; else echo 'fade';?>" id="menu1">
    <?php include 'children/file.php';?>
  </div>
  <div class="tab-pane container <?php if($t==2) echo 'active'; else echo 'fade';?>" id="menu2">
    <?php include 'children/price.php';?>
  </div>
  <div class="tab-pane container <?php if($t==3) echo 'active'; else echo 'fade';?>" id="menu3">
    <?php include 'children/irts.php';?>
  </div>
  <div class="tab-pane container <?php if($t==4) echo 'active'; else echo 'fade';?>" id="menu4">
    <?php include 'children/change.php';?>
  </div>
</div>
